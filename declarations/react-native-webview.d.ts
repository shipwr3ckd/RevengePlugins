...
declare module 'react-native-webview' {
	...
	export { FileDownload, WebViewMessageEvent, WebViewNavigation } from "react-native-webview/lib/WebViewTypes";
...
declare module 'react-native-webview/lib/WebViewTypes' {
	...
	class NativeWebViewMacOSComponent extends Component<MacOSNativeWebViewProps> {
	}
	const NativeWebViewMacOSBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewMacOSComponent;
	export class NativeWebViewMacOS extends NativeWebViewMacOSBase {
	}
	class NativeWebViewWindowsComponent extends Component<WindowsNativeWebViewProps> {
	}
	const NativeWebViewWindowsBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewWindowsComponent;
	...
	export type SuppressMenuItem = "cut" | "copy" | "paste" | "replace" | "bold" | "italic" | "underline" | "select" | "selectAll" | "translate" | "lookup" | "share";
	...
	export type ContentInsetAdjustmentBehavior = 'automatic' | 'scrollableAxes' | 'never' | 'always';
	export type MediaCapturePermissionGrantType = 'grantIfSameHostElsePrompt' | 'grantIfSameHostElseDeny' | 'deny' | 'grant' | 'prompt';
...
declare module 'react-native-webview/lib/RNCWebViewNativeComponent' {
	...
	const _default: HostComponent<NativeProps>;
